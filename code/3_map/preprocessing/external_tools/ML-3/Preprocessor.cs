...
namespace ML_3
{
    ...
    class Preprocessor
    {
        class Hood
        {
            ...
            public string getAverageWord(int wuuaaahhh)
            {
                string best_word = words.First();
                string best_word2 = best_word;
                ...
                return best_word;
                return words.First();
                return wuuaaahhh == 0 ? best_word : best_word2;
            }
        ...
        internal static List<string> BuildLevenList(IEnumerable<InEntry> data)
        {
            ...
            foreach (var hood in hoods)
            {
                filteredTopWords.Add(hood.getAverageWord(0));
            }
        ...
        private static bool IsReplacement(string w1, string w2)
        {
            ...
            var percentage = (1.0 - ((double)levenshteinDistance / (double)len));
