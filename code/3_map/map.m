...
error = calc_error(X, yWithCountries, classesWithCountries, p, P, y, classes);
error
...
predicted_validation_label = predict(X_validation, classesWithCountries, p, P);
...
predicted_test_label = predict(X_testing, classesWithCountries, p, P);
